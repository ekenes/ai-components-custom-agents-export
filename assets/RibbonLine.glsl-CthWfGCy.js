...
return size;
    ...
    `)),e.hasVVOpacity?(i.add("opacityFeatureAttribute","float"),a.constants.add("vvOpacityNumber","int",8),a.uniforms.add(new it("vvOpacityValues",ft,l=>l.vvOpacity.values),new it("vvOpacityOpacities",ft,l=>l.vvOpacity.opacityValues),new Y("vvOpacityFallback",l=>l.vvOpacity.fallback,{supportsNaN:!0})),a.code.add(s`
...
return vec4(col, opacity);
  ...
  `)}function wt(t){const e=t.stipplePattern;return Pt(e)?e.length:e?pa(e)/e.pixelRatio:1}const ma=.4,Lt=64,va=Lt/2,ga=va/5,Sa=Lt/ga,dn=.25;function xa(t,e){const a=t.vertex,i=e.hasScreenSizePerspective;qe(a),a.uniforms.get("markerScale")==null&&a.constants.add("markerScale","float",1),a.constants.add("markerSizePerLineWidth","float",Sa).code.add(s`
...
pos.xyz += normalize(other.xyz - pos.xyz) * getWorldMarkerSize(pos.xyz) * 0.5;
      ...
      ${F(p&&g,"float patternLineSize = getSize(clippedCenter);")}
      ${F(p&&!g,"float patternLineSize = lineSize;")}
...
vStretchFactor = noPerspectiveWrite(max(triangleHeight / (2.0 * lineWidth), 1.0), pos.w);
      ...
      `):n.main.add(s`
        ...
        ${F(p,s`joinDisplacementDir = (isStartVertex || subdivisionFactor > 0.0) ? endDir : startDir;`,s`joinDisplacementDir = mix(startDir, endDir, subdivisionFactor);`)}
...
float segmentLengthPseudoScreen = segmentLengthRender * discreteWorldToScreenRatio;`),n.uniforms.add(new Y("stipplePatternPixelSize",u=>wt(u))),n.main.add(s`
    ...
    ${F(R,s`float lineDistanceNorm = noPerspectiveRead(vLineDistanceNorm);`)}
...
color.a = noPerspectiveRead(color.a);`),h&&r.uniforms.add(new ke("innerColor",u=>u.innerColor??u.color),new Y("innerWidth",(u,C)=>u.innerWidth*C.camera.pixelRatio)).main.add(s`float distToInner = abs(lineDistance) - innerWidth;
...
finalColor.a *= 1.0 - clamp(feather, 0.0, 1.0);`),N&&r.main.add(s`
      ...
      `)),r.main.add(s`outputColorHighlightOLID(applySlice(finalColor, vpos), finalColor.rgb);`),e}const wa=Object.freeze(Object.defineProperty({__proto__:null,build:Ct,ribbonlineNumRoundJoinSubdivisions:Xe},Symbol.toStringTag,{value:"Module"}));function $t(t){const e=Ii().vec3f("position").vec4f16("previousDelta").vec4f16("nextDelta").f32("u0").vec2f16("lineParameters");return t.hasVVColor?e.f32("colorFeatureAttribute"):e.vec4u8("color",{glNormalized:!0}),t.hasVVSize?e.f32("sizeFeatureAttribute"):e.f32("size"),t.hasVVOpacity&&e.f32("opacityFeatureAttribute"),Dt()&&e.vec4u8("olidColor"),t.hasAnimation&&e.vec4f16("timeStamps"),e}let Ue=class extends mi{constructor(t,e){super(t,e,Mi($t(e))),this.shader=new vi(wa,()=>kt(()=>Promise.resolve().then(()=>ja),void 0)),this.ignoreUnused=!0,this.primitiveType=e.wireframe?Ze.LINES:Ze.TRIANGLE_STRIP}_makePipelineState(t,e){const{output:a,hasOccludees:i}=t;return be({blending:yi(a,!1,t.emissionDimmingPass),depthTest:xi(a),depthWrite:Si(t),colorWrite:Fe,stencilWrite:i?nt:null,stencilTest:i?e?at:gi:null,polygonOffset:ye(t)})}initializePipeline(t){if(t.occluder){const{hasOccludees:e}=t;this._occluderPipelineTransparent=be({blending:dt,polygonOffset:ye(t),depthTest:rt,depthWrite:null,colorWrite:Fe,stencilWrite:null,stencilTest:e?bi:null}),this._occluderPipelineOpaque=be({blending:dt,polygonOffset:ye(t),depthTest:e?rt:st,depthWrite:null,colorWrite:Fe,stencilWrite:e?zi:null,stencilTest:e?Di:null}),this._occluderPipelineMaskWrite=be({blending:null,polygonOffset:ye(t),depthTest:st,depthWrite:null,colorWrite:null,stencilWrite:e?nt:null,stencilTest:e?at:null})}return this._occludeePipeline=this._makePipelineState(t,!0),this._makePipelineState(t,!1)}getPipeline(t,e,a){if(a)return this._occludeePipeline;switch(t.occluder){case 11:return this._occluderPipelineTransparent??super.getPipeline(t,e,a);case 10:return this._occluderPipelineOpaque??super.getPipeline(t,e,a);default:t.occluder;case void 0:case null:return this._occluderPipelineMaskWrite??super.getPipeline(t,e,a)}}};Ue=T([Jt("esri.views.3d.webgl-engine.shaders.RibbonLineTechnique")],Ue);const La=16,Ca=8;class P extends Ti{constructor(e){super(),this.spherical=e,this.capType=0,this.emissionSource=0,this.animation=2,this.polygonOffsetIndex=0,this.writeDepth=!1,this.draped=!1,this.stippleEnabled=!1,this.stippleOffColorEnabled=!1,this.stipplePreferContinuous=!0,this.numJoinSubdivisions=1,this.roundJoins=!1,this.applyMarkerOffset=!1,this.hasVVSize=!1,this.hasVVColor=!1,this.hasVVOpacity=!1,this.falloffEnabled=!1,this.innerColorEnabled=!1,this.hasOccludees=!1,this.occluder=!1,this.wireframe=!1,this.discardInvisibleFragments=!1,this.hasScreenSizePerspective=!1,this.worldSizedImagePattern=!1,this.textureCoordinateType=0,this.hasVVInstancing=!1,this.hasSliceTranslatedView=!0,this.overlayEnabled=!1,this.snowCover=!1}get hasAnimation(){return this.animation!==0}}T([w({count:3})],P.prototype,"capType",void 0),T([w({count:8})],P.prototype,"emissionSource",void 0),T([w({count:4})],P.prototype,"animation",void 0),T([w({count:La})],P.prototype,"polygonOffsetIndex",void 0),T([w()],P.prototype,"writeDepth",void 0),T([w()],P.prototype,"draped",void 0),T([w()],P.prototype,"stippleEnabled",void 0),T([w()],P.prototype,"stippleOffColorEnabled",void 0),T([w()],P.prototype,"stipplePreferContinuous",void 0),T([w({count:Ca})],P.prototype,"numJoinSubdivisions",void 0),T([w()],P.prototype,"roundJoins",void 0),T([w()],P.prototype,"applyMarkerOffset",void 0),T([w()],P.prototype,"hasVVSize",void 0),T([w()],P.prototype,"hasVVColor",void 0),T([w()],P.prototype,"hasVVOpacity",void 0),T([w()],P.prototype,"falloffEnabled",void 0),T([w()],P.prototype,"innerColorEnabled",void 0),T([w()],P.prototype,"hasOccludees",void 0),T([w()],P.prototype,"occluder",void 0),T([w()],P.prototype,"wireframe",void 0),T([w()],P.prototype,"discardInvisibleFragments",void 0),T([w()],P.prototype,"hasScreenSizePerspective",void 0),T([w()],P.prototype,"worldSizedImagePattern",void 0);let $a=class extends Pi{constructor(e,a){super(e,_a),this.produces=new Map([[2,i=>wi(i)||Re(i)&&this.parameters.renderOccluded===8],[3,i=>Li(i)],[10,i=>ot(i)&&this.parameters.renderOccluded===8],[11,i=>ot(i)&&this.parameters.renderOccluded===8],[4,i=>Re(i)&&this.parameters.writeDepth&&this.parameters.renderOccluded!==8],[8,i=>Re(i)&&!this.parameters.writeDepth&&this.parameters.renderOccluded!==8],[18,i=>Ci(i)]]),this._configuration=new P(a)}updateConfiguration(e){super.updateConfiguration(e);const a=e.slot===18,i=this.parameters.stipplePattern!=null&&this.parameters.stippleTexture!=null&&e.output!==10,n=i&&a&&this.parameters.isImagePattern();this._configuration.draped=a,this._configuration.polygonOffset=this.parameters.polygonOffset,this._configuration.stippleEnabled=i,this._configuration.stippleOffColorEnabled=i&&this.parameters.stippleOffColor!=null,this._configuration.stipplePreferContinuous=i&&this.parameters.stipplePreferContinuous,this._configuration.numJoinSubdivisions=Ot(this.parameters.join,i),this._configuration.hasSlicePlane=this.parameters.hasSlicePlane,this._configuration.roundJoins=this.parameters.join==="round",this._configuration.capType=this.parameters.cap,this._configuration.applyMarkerOffset=this.parameters.markerParameters!=null&&Ea(this.parameters.markerParameters),this._configuration.polygonOffsetIndex=this.parameters.polygonOffsetIndex,this._configuration.writeDepth=this.parameters.writeDepth,this._configuration.hasVVSize=this.parameters.hasVVSize,this._configuration.hasVVColor=this.parameters.hasVVColor,this._configuration.hasVVOpacity=this.parameters.hasVVOpacity,this._configuration.innerColorEnabled=this.parameters.innerWidth>0&&this.parameters.innerColor!=null,this._configuration.falloffEnabled=this.parameters.falloff>0,this._configuration.hasOccludees=e.hasOccludees,this._configuration.occluder=this.parameters.renderOccluded===8,this._configuration.wireframe=this.parameters.wireframe,this._configuration.animation=this.parameters.animation,this._configuration.emissionSource=this.emissions?1:0,this._configuration.hasScreenSizePerspective=!!this.parameters.screenSizePerspective&&!n,this._configuration.worldSizedImagePattern=n}get visible(){return this.parameters.color[3]>=lt||this.parameters.stipplePattern!=null&&(this.parameters.stippleOffColor?.[3]??0)>lt}get emissions(){return this.parameters.emissiveStrength>0?this.parameters.renderOccluded!==8?2:1:0}setParameters(e,a){e.animation=this.parameters.animation,super.setParameters(e,a)}intersectDraped({attributes:e,screenToWorldRatio:a},i,n,r,l){if(!i.options.selectionMode)return;const d=e.get("size");let o=this.parameters.width;if(this.parameters.vvSize){const g=e.get("sizeFeatureAttribute").data[0];Number.isNaN(g)?o*=this.parameters.vvSize.fallback[0]:o*=$e(this.parameters.vvSize.offset[0]+g*this.parameters.vvSize.factor[0],this.parameters.vvSize.minSize[0],this.parameters.vvSize.maxSize[0])}else d&&(o*=d.data[0]);const c=n[0],p=n[1],m=(o/2+4)*a;let v=Number.MAX_VALUE,f=0;const h=e.get("position").data,N=Be(this.parameters,e)?h.length-2:h.length-5;for(let g=0;g<N;g+=3){const $=h[g],B=h[g+1],q=(g+3)%h.length,b=c-$,x=p-B,R=h[q]-$,A=h[q+1]-B,u=$e((R*b+A*x)/(R*R+A*A),0,1),C=R*u-b,V=A*u-x,z=C*C+V*V;z<v&&(v=z,f=g/3)}v<m*m&&r(l.distance,l.normal,f)}intersect(e,a,i,n,r,l){const{options:d,camera:o,rayBegin:c,rayEnd:p}=i;if(!d.selectionMode||!e.visible||!o)return;if(!Ei(a))return void Ut.getLogger("esri.views.3d.webgl-engine.materials.RibbonLineMaterial").error("intersection assumes a translation-only matrix");const m=e.attributes,v=m.get("position").data;let f=this.parameters.width;if(this.parameters.vvSize){const x=m.get("sizeFeatureAttribute").data[0];Number.isNaN(x)||(f*=$e(this.parameters.vvSize.offset[0]+x*this.parameters.vvSize.factor[0],this.parameters.vvSize.minSize[0],this.parameters.vvSize.maxSize[0]))}else m.has("size")&&(f*=m.get("size").data[0]);const h=Fa;Bt(h,i.point);const N=f*o.pixelRatio,g=4*o.pixelRatio,$=N/2+g;ee(fe[0],h[0]-$,h[1]+$,0),ee(fe[1],h[0]+$,h[1]+$,0),ee(fe[2],h[0]+$,h[1]-$,0),ee(fe[3],h[0]-$,h[1]-$,0);for(let x=0;x<4;x++)if(!o.unprojectFromRenderScreen(fe[x],ie[x]))return;Se(o.eye,ie[0],ie[1],Ve),Se(o.eye,ie[1],ie[2],Ie),Se(o.eye,ie[2],ie[3],Me),Se(o.eye,ie[3],ie[0],je);let B=Number.MAX_VALUE,q=0;const b=Be(this.parameters,m)?v.length-2:v.length-5;for(let x=0;x<b;x+=3){I[0]=v[x]+a[12],I[1]=v[x+1]+a[13],I[2]=v[x+2]+a[14];const R=(x+3)%v.length;if(M[0]=v[R]+a[12],M[1]=v[R+1]+a[13],M[2]=v[R+2]+a[14],Z(Ve,I)<0&&Z(Ve,M)<0||Z(Ie,I)<0&&Z(Ie,M)<0||Z(Me,I)<0&&Z(Me,M)<0||Z(je,I)<0&&Z(je,M)<0)continue;const A=o.projectToRenderScreen(I,Aa),u=o.projectToRenderScreen(M,Wa);if(A==null||u==null)continue;if(A[2]<0&&u[2]>0){se(Q,I,M);const z=o.frustum,X=-Z(z[4],I)/Oe(Q,Qe(z[4]));if(_e(Q,Q,X),Ke(I,I,Q),!o.projectToRenderScreen(I,A))continue}else if(A[2]>0&&u[2]<0){se(Q,M,I);const z=o.frustum,X=-Z(z[4],M)/Oe(Q,Qe(z[4]));if(_e(Q,Q,X),Ke(M,M,Q),!o.projectToRenderScreen(M,u))continue}else if(A[2]<0&&u[2]<0)continue;A[2]=0,u[2]=0;const C=Ee(A,u,St),V=Ai(C,h);if(!(V>=B)){if(this.parameters.screenSizePerspective){const z=this.computeScreenSizePerspectiveWidth(C,I,M,h,o,f,g);if(V>=z*z)continue}B=V,oe(vt,I),oe(gt,M),q=x/3}}if(B<$*$){let x=Number.MAX_VALUE;if(Wi(Ee(vt,gt,St),Ee(c,p,Va),K)){se(K,K,c);const R=et(K);_e(K,K,1/R),x=R/He(c,p)}l(x,K,q)}}createBufferWriter(){return new Ra($t(this.parameters),this.parameters)}createGLMaterial(e){return new Oa(e)}validateParameters(e){e.join!=="miter"&&(e.miterLimit=0),e.markerParameters!=null&&(e.markerScale=e.markerParameters.width/e.width)}update(e){return!!this.parameters.hasAnimation&&(this.setParameters({timeElapsed:Ht(e.time)},!1),e.dt!==0)}computeScreenSizePerspectiveWidth(e,a,i,n,r,l,d){const o=Vi(e,n);Gt(We,a,i,o),re(mt,We,r.viewMatrix);const c=et(mt),p=this.computeCameraAbsCosAngle(We,r,this._configuration.spherical);return ut.update(p,c,this.parameters.screenSizePerspective,this.parameters.screenSizePerspectiveMinPixelReferenceSize),ut.apply(l)*r.pixelRatio/2+d}computeCameraAbsCosAngle(e,a,i){return i?tt(K,e):ee(K,0,0,1),se(ze,e,a.eye),tt(ze,ze),Math.abs(Oe(K,ze))}};class Oa extends _i{constructor(){super(...arguments),this._stipplePattern=null}dispose(){super.dispose(),this._stippleTextures?.release(this._stipplePattern),this._stipplePattern=null}beginSlot(e){const{stipplePattern:a}=this._material.parameters;return this._stipplePattern!==a&&(this._material.setParameters({stippleTexture:this._stippleTextures.swap(a,this._stipplePattern)}),this._stipplePattern=a),this.getTechnique(Ue,e)}}class _a extends Oi{constructor(){super(...arguments),this._width=0,this.color=qt,this.join="miter",this.cap=0,this.miterLimit=5,this.writeDepth=!0,this.polygonOffset=0,this.polygonOffsetIndex=0,this.stippleTexture=null,this.stipplePreferContinuous=!0,this.markerParameters=null,this.markerScale=1,this.hasSlicePlane=!1,this.vvFastUpdate=!1,this.isClosed=!1,this.falloff=0,this.innerWidth=0,this.wireframe=!1,this.timeElapsed=he(0),this.animation=0,this.animationSpeed=1,this.trailLength=1,this.startTime=he(0),this.endTime=he(1/0),this.emissiveStrength=0}get width(){return this.isImagePattern()?this.stipplePattern.width:this._width}set width(e){this._width=e}get transparent(){return this.color[3]<1||this.hasAnimation||this.stipplePattern!=null&&(this.stippleOffColor?.[3]??0)<1}get hasAnimation(){return this.animation!==0}isImagePattern(){return Pt(this.stipplePattern)&&this.stippleTexture!=null}}class Ra{constructor(e,a){this.layout=e,this._parameters=a,this.numJoinSubdivisions=Ot(this._parameters.join,this._parameters.stipplePattern!=null)}_isClosed(e){return Be(this._parameters,e)}allocate(e){return this.layout.createBuffer(e)}elementCount(e){const i=e.get("position").indices.length/2+1,n=this._isClosed(e);let r=n?2:4;return r+=((n?i:i-1)-(n?0:1))*(2*this.numJoinSubdivisions+4),r+=2,this._parameters.wireframe&&(r=2+4*(r-2)),r}write(e,a,i,n,r){if(r==null)return;const{buffer:l,offset:d}=r,o=this.layout,c=i.get("position"),p=c.indices,m=c.data.length/3,v=i.get("distanceToStart")?.data;p&&p.length!==2*(m-1)&&console.warn("RibbonLineMaterial does not support indices");const f=o.fields.has("sizeFeatureAttribute");let h=1,N=null;if(f){const S=i.get("sizeFeatureAttribute");S.data.length===1?h=S.data[0]:N=S.data}else h=i.get("size")?.data[0]??1;let g=[1,1,1,1],$=0,B=null;const q=o.fields.has("colorFeatureAttribute");if(q){const S=i.get("colorFeatureAttribute");S.data.length===1?$=S.data[0]:B=S.data}else g=i.get("color")?.data??g;const b=i.get("timeStamps")?.data,x=b&&o.fields.has("timeStamps"),R=o.fields.has("opacityFeatureAttribute");let A=0,u=null;if(R){const S=i.get("opacityFeatureAttribute");S.data.length===1?A=S.data[0]:u=S.data}const C=new Float32Array(l.buffer),V=Fi(l.buffer),z=new Uint8Array(l.buffer),X=o.stride/4;let D=d*X;const we=D;let k=0;const Le=v?(S,G,ne)=>k=v[ne]:(S,G,ne)=>k+=He(S,G),ae=C.BYTES_PER_ELEMENT/V.BYTES_PER_ELEMENT,Ye=4/ae,_t=Dt(),H=(S,G,ne,U,me,Rt,ve,Et)=>{C[D++]=G[0],C[D++]=G[1],C[D++]=G[2],ct(S,G,V,D*ae),D+=Ye,ct(ne,G,V,D*ae),D+=Ye,C[D++]=Et;let te=D*ae;if(V[te++]=me,V[te++]=Rt,D=Math.ceil(te/ae),q)C[D]=B?.[ve]??$;else{const J=Math.min(4*ve,g.length-4),ge=4*D;z[ge]=255*g[J],z[ge+1]=255*g[J+1],z[ge+2]=255*g[J+2],z[ge+3]=255*g[J+3]}if(D++,C[D++]=N?.[ve]??h,R&&(C[D++]=u?.[ve]??A),_t){let J=4*D;n?(z[J++]=n[0],z[J++]=n[1],z[J++]=n[2],z[J++]=n[3]):(z[J++]=0,z[J++]=0,z[J++]=0,z[J++]=0),D=Math.ceil(.25*J)}x&&(te=D*ae,V[te++]=U[0],V[te++]=U[1],V[te++]=U[2],V[te++]=U[3],D=Math.ceil(te/ae))};D+=X,ee(y,c.data[0],c.data[1],c.data[2]),x&&Te(j,b[0],b[1],b[2],b[3]),e&&re(y,y,e);const ue=this._isClosed(i);if(ue){const S=c.data.length-3;ee(E,c.data[S],c.data[S+1],c.data[S+2]),e&&re(E,E,e)}else ee(L,c.data[3],c.data[4],c.data[5]),e&&re(L,L,e),H(y,y,L,j,1,-4,0,0),H(y,y,L,j,1,4,0,0),oe(E,y),oe(y,L),x&&Te(j,b[4],b[5],b[6],b[7]);const Ce=ue?0:1,de=ue?m:m-1;for(let S=Ce;S<de;S++){const G=(S+1)%m*3;ee(L,c.data[G],c.data[G+1],c.data[G+2]),e&&re(L,L,e),Le(E,y,S),H(E,y,L,j,0,-1,S,k),H(E,y,L,j,0,1,S,k);const ne=this.numJoinSubdivisions;for(let U=0;U<ne;++U){const me=(U+1)/(ne+1);H(E,y,L,j,me,-1,S,k),H(E,y,L,j,me,1,S,k)}if(H(E,y,L,j,1,-2,S,k),H(E,y,L,j,1,2,S,k),oe(E,y),oe(y,L),x){const U=(S+1)%m*4;Te(j,b[U],b[U+1],b[U+2],b[U+3])}}ue?(ee(L,c.data[3],c.data[4],c.data[5]),e&&re(L,L,e),k=Le(E,y,de),H(E,y,L,j,0,-1,Ce,k),H(E,y,L,j,0,1,Ce,k)):(k=Le(E,y,de),H(E,y,y,j,0,-5,de,k),H(E,y,y,j,0,5,de,k)),Ae(C,we+X,C,we,X),D=Ae(C,D-X,C,D,X),this._parameters.wireframe&&this._addWireframeVertices(l,we,D,X)}_addWireframeVertices(e,a,i,n){const r=new Float32Array(e.buffer,i*Float32Array.BYTES_PER_ELEMENT),l=new Float32Array(e.buffer,a*Float32Array.BYTES_PER_ELEMENT,i-a);let d=0;const o=c=>d=Ae(l,c,r,d,n);for(let c=0;c<l.length-1;c+=2*n)o(c),o(c+2*n),o(c+1*n),o(c+2*n),o(c+1*n),o(c+3*n)}}function Ae(t,e,a,i,n){for(let r=0;r<n;r++)a[i++]=t[e++];return i}function Be(t,e){return t.isClosed?e.get("position").indices.length>2:!1}function Ea(t){return t.anchor===1&&t.hideOnShortSegments&&t.placement==="begin-end"&&t.worldSpace}function Ot(t,e){const a=e?1:0;switch(t){case"miter":case"bevel":return a;case"round":return Xe+a}}const ut=new $i,I=_(),M=_(),We=_(),mt=_(),ze=_(),Q=_(),K=_(),Fa=_(),Aa=le(),Wa=le(),vt=_(),gt=_(),St=zt(),Va=zt(),E=_(),y=_(),L=_(),j=yt(),fe=[le(),le(),le(),le()],ie=[_(),_(),_(),_()],Ve=Pe(),Ie=Pe(),Me=Pe(),je=Pe();class fn{constructor(e){this._originSR=e,this._rootOriginId="root/"+Xt(),this._origins=new Map,this._objects=new Map,this._gridSize=5e5,this._originSR?.isGeographic&&(this._gridSize/=Yt(this._originSR)),this._baselineDistance=.5*this._gridSize;const a=this._baselineDistance*Ia;this._baselineObjectSize=a/Ma}getOrigin(e){const a=this._origins.get(this._rootOriginId);if(a==null){const p=pt(e[0]+Math.random()-.5,e[1]+Math.random()-.5,e[2]+Math.random()-.5,this._rootOriginId);return this._origins.set(this._rootOriginId,p),p}const i=this._gridSize,n=Math.round(e[0]/i),r=Math.round(e[1]/i),l=Math.round(e[2]/i),d=`${n}/${r}/${l}`;let o=this._origins.get(d);const c=.5*i;if(se(O,e,a.vec3),O[0]=Math.abs(O[0]),O[1]=Math.abs(O[1]),O[2]=Math.abs(O[2]),O[0]<c&&O[1]<c&&O[2]<c){if(o){const p=Math.max(...O);if(se(O,e,o.vec3),O[0]=Math.abs(O[0]),O[1]=Math.abs(O[1]),O[2]=Math.abs(O[2]),Math.max(...O)<p)return o}return a}return o||(o=pt(n*i,r*i,l*i,d),this._origins.set(d,o)),o}needsOriginUpdate(e,a,i){const n=He(e.vec3,a),r=Math.max(1,i/this._baselineObjectSize);return n>this._baselineDistance*r}_drawOriginBox(e,a=Zt(1,1,0,1)){const i=window.view,n=i.stage,r=a.toString();if(!this._objects.has(r)){this._material=new $a({width:2,color:a},!1);const f=new ti(n,{pickable:!1}),h=new ii({castShadow:!1});f.add(h),this._objects.set(r,h)}const l=this._objects.get(r),d=[0,1,5,4,0,2,1,7,6,2,0,1,3,7,5,4,6,2,0],o=d.length,c=new Array(3*o),p=new Array,m=.5*this._gridSize;for(let f=0;f<o;f++)c[3*f]=e[0]+(1&d[f]?m:-m),c[3*f+1]=e[1]+(2&d[f]?m:-m),c[3*f+2]=e[2]+(4&d[f]?m:-m),f>0&&p.push(f-1,f);Ne(c,this._originSR,0,c,i.renderSpatialReference,0,o);const v=new Ri(this._material,[["position",new ai(c,p,3,!0)]],null,2);l.addGeometry(v)}get test(){}}const O=_(),Ia=2**-23,Ma=.05,ja=Object.freeze(Object.defineProperty({__proto__:null,build:Ct,ribbonlineNumRoundJoinSubdivisions:Xe},Symbol.toStringTag,{value:"Module"}));export{Ki as A,$a as H,an as a,ln as b,en as c,fn as d,la as e,tn as f,rn as g,xa as h,La as i,ca as j,Lt as k,Ka as l,nn as m,Je as n,va as o,Gi as p,dn as q,cn as r,ya as s,pt as t,Tt as u};
//# sourceMappingURL=RibbonLine.glsl-CthWfGCy.js.map
