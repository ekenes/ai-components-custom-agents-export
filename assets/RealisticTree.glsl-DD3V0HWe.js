import{ap as T,lZ as pe,mz as za,ea as Fa,og as Pa,m9 as $a,iS as ce,lX as ja,G4 as Oa,x6 as Ra,o3 as Wa,G5 as Rt,ja as Wt,Z as c,$ as G,a1 as j,G6 as Na,G7 as Ea,j2 as Nt,mo as Qe,my as de,m7 as yt,lV as Ga,sJ as wt,pH as K,o4 as X,lo as et,_ as B,gH as ge,dX as Ba,dZ as La,cf as Et,lq as Va,vP as Gt,fR as Aa,EZ as E,jo as Ha,k$ as We,hw as Ua,fO as ka,et as Za,es as Ne,iQ as qa,eq as Mt,er as Ja,gq as Ya,fL as Xa}from"./index-D_3mGFmj.js";import{L as R,aw as N,g as Bt,ax as Ie,ay as Lt,az as Vt,a9 as we,aA as Ka,aB as Qa,M as eo,aC as se,K as x,P as At,f as U,aD as k,u as le,O as w,h as Z,R as to,d as ao,aE as Ht,ae as W,aF as De,E as tt,i as Q,t as L,Q as O,C as ze,aa as Me,aG as oo,a8 as ue,aH as io,y as Fe,aI as ro,D as Se,e as Ut,aJ as kt,x as at,b as Zt,k as no,l as so,o as lo,z as co,j as uo,r as ho,n as mo,p as po,s as fo,aK as Ee,_ as vo}from"./TriangleTechniqueConfiguration-BKNfD3Xf.js";import{t as go,c as Pe,a as ee,i as xo,r as ot,n as qt,b as bo}from"./BooleanBindUniform-uq0laogH.js";import{o as q,i as yo,r as Jt,s as wo,m as Mo,e as So}from"./VertexColor.glsl-BZzIT_X_.js";import{a as To,c as Yt,d as it,o as fe,u as Xt,b as J,f as rt,_ as _o,e as Co,n as Kt,O as Io}from"./SceneLighting-BVz1aP2D.js";import{t as Ue,Q as nt}from"./InterleavedLayout-DDoeeqMm.js";import{i as $,L as Qt,Q as Te,J as St}from"./BufferView-DiCyeelK.js";import{r as Do}from"./VertexBuffer-CF8DOnzJ.js";import{O as te,g as ae,_ as zo}from"./renderState-DgudKykW.js";import{t as i,n as v,b as Fo,i as p,a as ea}from"./oitResolution.glsl-9MtkgdH8.js";import{s as V}from"./ShaderBuilder-C7k9L4t6.js";import{c as A}from"./NoParameters-DB-WZ6gy.js";function $e(t,e){switch(t.fragment.code.add(i`vec3 screenDerivativeNormal(vec3 positionView) {
...
return color;
    ...
    }`)}const xe=T();function na(t,e){t.varyings.add("colorMixMode","int"),t.varyings.add("opacityMixMode","int"),t.vertex.uniforms.add(new To("symbolColorMixMode",a=>se[a.colorMixMode])),e.hasSymbolColors?(t.vertex.include(Ie),t.vertex.include(Lt),t.vertex.include(Vt),t.attributes.add("symbolColor","vec4"),t.vertex.code.add(i`
...
forwardTextureCoordinates();`),t.include(Y,e),o.main.add(i`
        ...
        ${v(s,i`vec4 texColor = texture(tex, ${h?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}`);break;case 5:case 6:case 7:case 8:case 11:U(a,e),t.include(q),t.include(k,e),t.include(le,e),t.include(ko,e),o.include(Z,e),t.include(ao,e),yo(t),r.add("depth","float",{invariant:!0}),s&&o.uniforms.add(new w("tex",g=>g.texture)),a.main.add(i`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
inputs.f90 =  vec3(clamp(dot(inputs.f0, vec3(50.0 * 0.33)), 0.0, 1.0));
}`)}function Yr(t,e){t.include(rt),t.code.add(i`
...
}`)}function li(t){t.include(ee),t.uniforms.add(new tt("zProjectionMapLastFrame",e=>xo(e.reprojection.lastFrameCamera))),t.code.add(i`float linearDepthFromTextureLastFrame(sampler2D depthTexture, vec2 uv) {
